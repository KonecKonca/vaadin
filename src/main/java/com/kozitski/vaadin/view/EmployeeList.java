package com.kozitski.vaadin.view;

import com.kozitski.vaadin.components.EmployeeEditor;
import com.kozitski.vaadin.domain.Employee;
import com.kozitski.vaadin.repository.EmployeeRepo;
...
public class EmployeeList extends VerticalLayout {
    ...
    public EmployeeList(EmployeeRepo employeeRepo, EmployeeEditor employeeEditor) {
        ...
        employeeGrid.getColumns().forEach(e -> {
